...
#[bench]
fn bench_skip_f32(b: &mut Bencher) {
    skip_points::<f32>(b);
}

/// Generates N `f64` points
#[bench]
fn bench_skip_f64(b: &mut Bencher) {
    skip_points::<f64>(b);
}

/// Generates N `u8` points
#[bench]
fn bench_skip_u8(b: &mut Bencher) {
    skip_points::<u8>(b);
}

/// Generates N `u16` points
#[bench]
fn bench_skip_u16(b: &mut Bencher) {
    skip_points::<u16>(b);
}

/// Generates N `u32` points
#[bench]
fn bench_skip_u32(b: &mut Bencher) {
    skip_points::<u32>(b);
}

/// Generates N `u64` points
#[bench]
fn bench_skip_u64(b: &mut Bencher) {
    skip_points::<u64>(b);
}

/// Generates N `u128` points
#[bench]
fn bench_skip_u128(b: &mut Bencher) {
    skip_points::<u128>(b);
}

/// Generates N `i8` points
#[bench]
fn bench_skip_i8(b: &mut Bencher) {
    skip_points::<i8>(b);
}

/// Generates N `i16` points
#[bench]
fn bench_skip_i16(b: &mut Bencher) {
    skip_points::<i16>(b);
}

/// Generates N `i32` points
#[bench]
fn bench_skip_i32(b: &mut Bencher) {
    skip_points::<i32>(b);
}

/// Generates N `i64` points
#[bench]
fn bench_skip_i64(b: &mut Bencher) {
    skip_points::<i64>(b);
}

/// Generates N `i128` points
#[bench]
fn bench_skip_i128(b: &mut Bencher) {
    skip_points::<i128>(b);
}
...
where
    ...
    Sobol<T>: Clone,
{
    let sobol = Sobol::<T>::new(DIMS, &JoeKuoD6::EXTENDED).unwrap();
